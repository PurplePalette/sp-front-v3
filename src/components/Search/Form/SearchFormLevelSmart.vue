<template>
    <v-row justify="center" align="center" dense>
        <!-- キーワード検索 -->
        <v-col class="mb-0 py-0" cols="12" sm="8" md="6" lg="3">
            <v-form ref="form">
                <v-text-field
                    v-model="keyword"
        ...
        <!-- ジャンル -->
        <v-col class="mb-0 py-0" cols="12" sm="4" md="6" lg="3">
            <v-select
                v-model="genre"
                :items="genres"
        ...
        <!-- 難易度 -->
        <v-col class="mb-0 py-0" cols="12" sm="6" md="6" lg="3">
            <v-select
                v-model="difficulty"
                :items="difficulties"
        ...
        <!-- 曲の長さ -->
        <v-col class="mb-0 pa-0" cols="12" sm="6" md="6" lg="3">
            <v-select
                v-model="length"
                :items="lengths"
        ...
        <!-- ソート -->
        <v-col class="mt-n4 pa-0" cols="12" sm="6" md="6" lg="6">
            <v-select
                v-model="sort"
                :items="sorts"
